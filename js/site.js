...
var heroBgList = ['hero-1', 'hero-2', 'hero-3', 'hero-4', 'hero-5', 'hero-6'];
...
function createModal()
{
  ...
  if (heroBookingButton || footerBookingButton) {
    heroBookingButton.onclick = function(e) {
      ...
      modal.innerHTML = '<h1>Choose location</h1> <a style="margin-top: 10px;" class="btn gradient" href="https://bookeo.com/gratitudebeauty-second">16th Ave NW</a>';
